...
- [`generate-graphql-query`](./packages/generate-graphql-query/) A module to help us generate GraphQL query from JavaScript object. This module has **zero dependencies** and the bundle size of it is small (**under 3kB before gzipped**). This module should be installed as a dependency for your web application. You can [click here to read the docs](./packages/generate-graphql-query/README.md).

[To get started, please read the docs of generate-graphql-client](./packages/generate-graphql-client/README.md). [To try GraphQL Toolkit, visit the playground here](https://mygqljs.github.io/).
